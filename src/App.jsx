  ...
  return (
    <div className="min-h-screen bg-blue-100 text-gray-800 font-serif scroll-smooth">
      ...
      <section id="about" className="max-w-7xl mx-auto px-6 py-32 grid md:grid-cols-2 gap-20 items-center">
        <img src="/public/images/truck-front.png.png" alt="FZL Training Truck" className="rounded-3xl shadow-2xl w-full" />
        <div>
      ...
      <section id="vehicles" className="py-32 bg-white text-center">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto px-6">
          <img src="/public/images/truck-front.png.png" alt="Truck" className="rounded-3xl shadow-2xl w-full" />
          <img src="/public/images/car-front.png.png" alt="Car Front" className="rounded-3xl shadow-2xl w-full" />
          <img src="/public/images/car-side.png.png" alt="Car Side" className="rounded-3xl shadow-2xl w-full" />
        </div>
      </section>
